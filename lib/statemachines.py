...
class OrderCreation:
    ...
    def __init__(self, user_id):
        ...
        self.machine.add_transition("set_currency_from", "currency_from", "currency_to")  # Currently not used
        self.machine.add_transition("set_currency_to", "currency_to", "amount")  # Currently not used
