...
class TestTgApp(unittest.TestCase):
    ...
    def test_simple_match(self):
        self.tg.add_message(1, "SELL 1500 RUB * 98.1 AMD min_amt 100")
        self.tg.add_message(2, "BUY 1500 RUB * 98.1 AMD min_amt 100")
        self.assertEqual(2, len(self.tg.outgoing))

    def test_simple_no_match(self):
        self.tg.add_message(1, "SELL 1500 RUB * 98.1 AMD min_amt 100")
        self.tg.add_message(2, "BUY 1500 RUB * 98.01 AMD min_amt 100")
        self.assertEqual(0, len(self.tg.outgoing))

    def test_simple_best_price(self):
        self.tg.add_message(1, "SELL 1500 RUB * 98.1 AMD min_amt 100")
        self.tg.add_message(2, "SELL 1500 RUB * 100 AMD min_amt 100")
        self.tg.add_message(3, "SELL 1500 RUB * 110 AMD min_amt 100")
        self.tg.add_message(100, "BUY 1500 RUB * 98.1 AMD min_amt 100")
        self.assertEqual(2, len(self.tg.outgoing))
        self.assertIn("for 98.10 per unit", self.tg.outgoing[0].text)

    def test_check_price_valid(self):
        self.tg.add_message(1, "SELL 1000 RUB * 4.54 AMD min_amt 100")

    def test_check_price_invalid_decimal(self):
        self.tg.add_message(1, "SELL 1000 RUB * 4.541 AMD min_amt 100")
    ...
    def test_check_price_invalid_value(self):
        self.tg.add_message(1, "SELL 1000 RUB * INVALID AMD min_amt 100")
